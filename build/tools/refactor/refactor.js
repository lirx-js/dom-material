...
const REFACTOR_DIRECTORY_PATH = $path.join(ROOT_PATH, 'src/components/buttons/mat-button/built-in/basic');

const SIMPLE_REFACTOR_FROM = 'flat';
const SIMPLE_REFACTOR_TO = 'basic';
